...
<body class="text-slate-700">
    ...
    <!-- Main Content --><main class="container mx-auto px-6 pb-12">
        ...
        <!-- Poem Section --><section class="my-16 max-w-4xl mx-auto p-8 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg text-center">
        ...
        <!-- Zaman Tünelimiz Section --><section class="my-16 max-w-3xl mx-auto p-8 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg">
            <h3 class="text-3xl font-bold text-center text-green-600 mb-12">Zaman Tünelimiz</h3>
            <div class="relative pl-8">
                <!-- Dikey Çizgi -->
                <div class="absolute left-0 top-2 h-full border-l-2 border-green-300"></div>

                <!-- Olay 1 -->
                <div class="mb-12 relative">
                    <div class="absolute -left-11 top-1 w-6 h-6 bg-green-500 rounded-full border-4 border-white flex items-center justify-center">
                         <i class="fas fa-handshake text-white text-xs"></i>
                    </div>
                    <p class="font-bold text-green-600">27 Eylül 2025</p>
                    <h4 class="font-semibold text-lg text-slate-800">Tanışma</h4>
                    <p class="text-slate-600">Her şeyin başladığı o güzel sonbahar günü...</p>
                </div>
                ...
                <div class="mb-12 relative">
                    ...
                    <p class="font-bold text-green-600">Ekim 2025</p>
                    <h4 class="font-semibold text-lg text-slate-800">İlk Kahve</h4>
                    <p class="text-slate-600">Zamanın nasıl geçtiğini anlamadığımız ilk uzun sohbetimiz.</p>
                </div>
                ...
                <div class="mb-12 relative">
                    ...
                    <h4 class="font-semibold text-lg text-slate-800">Evlilik Teklifi</h4>
                    <p class="text-slate-600">"Evet!" dediği o unutulmaz an...</p>
                </div>
                ...
                <div class="relative">
                    ...
                    <p class="font-bold text-green-600">...ve Sonsuza Dek</p>
                    <h4 class="font-semibold text-lg text-slate-800">Hikayemiz Devam Ediyor</h4>
                    <p class="text-slate-600">Geri kalanını birlikte yazmak için...</p>
                </div>
        ...
        <!-- Wish Box Section (Re-added) --><section class="my-16 max-w-3xl mx-auto p-8 bg-white/80 backdrop-blur-sm rounded-lg shadow-lg">
