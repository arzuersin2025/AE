...
<head>
    ...
    <style>
        ...
        .travel-folder{position:relative;overflow:hidden;border-radius:.5rem;box-shadow:0 4px 6px rgba(0,0,0,.1);aspect-ratio:1/1;background:#f0fdf4;border:1px solid #a7f3d0;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:.75rem;text-align:center;transition:transform .2s ease-in-out,box-shadow .2s ease-in-out}
        .travel-folder:hover{transform:translateY(-5px);box-shadow:0 6px 12px rgba(0,0,0,.1)}
        .travel-folder h4{font-weight:700!important;font-size:.875rem!important;line-height:1.3!important;margin:.5rem 0 .25rem 0!important;color:#1f2937!important}
        .travel-folder p{font-weight:700!important;font-style:italic;font-size:.75rem!important;color:#6b7280!important;margin:0!important}
        ...
        .poem-container{max-width:90%;margin:0 auto;padding:2rem 0;line-height:1.4;font-size:1.725rem;font-style:italic;color:#16a34a!important;text-align:center}
        .poem-line{display:block;margin:0;padding:0;color:#16a34a!important}
        @media(max-width:768px){.poem-container{padding:1.5rem 0!important;line-height:1.3!important;font-size:1.95rem}}
        ...
        .leaf-svg{position:absolute;width:32px;height:44px;opacity:.9;animation:fall linear infinite;transform-origin:center;filter:drop-shadow(0 3px 6px rgba(0,0,0,.3))}
        @keyframes fall{0%{transform:translateY(-120px) rotate(0deg) scale(1);opacity:0}8%{opacity:.9}30%{transform:translateY(30vh) translateX(15px) rotate(180deg) scale(.95)}50%{transform:translateY(50vh) translateX(-20px) rotate(540deg) scale(.9)}70%{transform:translateY(70vh) translateX(25px) rotate(800deg) scale(.85)}92%{opacity:.9}100%{transform:translateY(110vh) translateX(-15px) rotate(1080deg) scale(.6);opacity:0}}
        .leaf-svg .leaf-inner{fill:currentColor}.leaf-svg .leaf-outer{fill:white;opacity:.95}
        ...
        .music-visualizer{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);display:flex;align-items:center;justify-content:center;gap:6px;z-index:15;opacity:1;transition:opacity .3s ease;width:200px;pointer-events:none}
        ...
        .note:nth-child(1){animation-delay:0s}.note:nth-child(2){animation-delay:.2s}.note:nth-child(3){animation-delay:.4s}.note:nth-child(4){animation-delay:.6s}.note:nth-child(5){animation-delay:.8s}.note:nth-child(6){animation-delay:1s}.note:nth-child(7){animation-delay:1.2s}.note:nth-child(8){animation-delay:1.4s}
        @keyframes floatNote{0%,100%{transform:translateY(0) scale(1);opacity:.7}50%{transform:translateY(-12px) scale(1.3);opacity:1}}
        ...
        .song-label{font-size:.65rem;font-weight:600;color:#dc2626;line-height:1;letter-spacing:.5px;text-transform:uppercase;white-space:nowrap;margin-bottom:.5rem;text-shadow:0 1px 2px rgba(0,0,0,.1)}
        #play-song-btn{width:44px;height:44px;background:rgba(239,68,68,.95);color:white;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:1.2rem;box-shadow:0 6px 16px rgba(0,0,0,.35);cursor:pointer;transition:all .3s ease}
        #play-song-btn:hover{background:#dc2626;transform:scale(1.15);box-shadow:0 8px 20px rgba(220,38,38,.45)}
        #play-song-btn.playing{background:#16a34a}
        #youtube-player{position:absolute;inset:0;width:100%;height:100%;border-radius:50%;opacity:0;pointer-events:none;transition:opacity .3s ease}
        ...
        .header-name{font-size:9vw}.header-heart{font-size:10vw;margin:0 .2em}
        ...
        @keyframes heartRainFall{0%{opacity:0;transform:translateY(-100px) rotate(0deg) scale(.6)}10%{opacity:1}90%{opacity:1}100%{opacity:0;transform:translateY(calc(100vh+100px)) rotate(1080deg) scale(.3)}}
        #map-icon{cursor:pointer;font-size:4rem;color:#dc2626!important;opacity:1!important;filter:drop-shadow(0 4px 10px rgba(220,38,38,.5));transition:all .3s ease;animation:gentlePulse 3s infinite ease-in-out}
        @media(max-width:768px){#map-icon{font-size:3rem}}
        #map-icon:hover{color:#b91c1c!important;transform:scale(1.12);filter:drop-shadow(0 6px 16px rgba(220,38,38,.7))}
        @keyframes gentlePulse{0%,100%{transform:scale(1)}50%{transform:scale(1.04)}}
        .map-click-text{font-size:.9rem;font-weight:600;color:#dc2626;margin-top:.5rem;opacity:.9;transition:all .3s ease}
        #map-icon:hover+.map-click-text{opacity:1;transform:translateY(-2px)}
        #invitation-icon{font-size:3.8rem;color:#dc2626;filter:drop-shadow(0 4px 10px rgba(220,38,38,.4));transition:all .3s ease;cursor:pointer}
        @media(max-width:768px){#invitation-icon{font-size:3rem}}
        #invitation-icon:hover{transform:scale(1.15);color:#b91c1c}
        .invitation-click-text{font-size:.9rem;font-weight:600;color:#dc2626;margin-top:.5rem;opacity:.9}
        #invitation-icon:hover+.invitation-click-text{opacity:1}
        #invitation-modal{display:none;position:fixed;inset:0;background:rgba(0,0,0,.9);z-index:9999;align-items:center;justify-content:center;padding:1rem}
        #invitation-modal.show{display:flex}
        #invitation-modal img{max-width:95vw;max-height:95vh;border-radius:12px;box-shadow:0 20px 40px rgba(0,0,0,.6)}
...
<body class="text-black">
        ...
        <div class="relative">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-12 max-w-2xl mx-auto px-4">
                    <img src="https://i.imgur.com/mpWmYzS.jpg" alt="Arzu & Ersin" class="w-full rounded-3xl shadow-2xl border-10 border-white/90 hover:scale-105 transition duration-1000 object-cover" loading="eager">
                </div>
            </div>
        </div>
    </header>
    ...
    <div id="image-modal" class="fixed inset-0 bg-black bg-opacity-90 hidden items-center justify-center z-50 p-4">
        ...
        <div id="prev-photo"><i class="fas fa-chevron-left"></i></div>
        <div id="next-photo"><i class="fas fa-chevron-right"></i></div>
    </div>
    ...
    (() => {
        ...
        const photos = Array.from(photoItems).map(el => el.querySelector('img').dataset.src);
        let currentIndex = 0;
        ...
        document.getElementById('close-modal').onclick = () => imageModal.classList.replace('flex', 'hidden');
        imageModal.onclick = e => e.target === imageModal && imageModal.classList.replace('flex', 'hidden');
